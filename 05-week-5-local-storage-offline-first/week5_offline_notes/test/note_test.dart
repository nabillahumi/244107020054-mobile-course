...
void main() {
  ...
  test('provider sukses dengan repository palsu', () async {
    ...
    final notes = await container.read(notesNotifierProvider.future);
  ...
  test('provider error dengan repository palsu', () async {
    ...
    // Memicu provider
    container.read(notesNotifierProvider);

    // Beri waktu agar AsyncNotifier menyelesaikan proses async
